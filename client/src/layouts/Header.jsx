...
export default function Header() {
  return (
    <header className="h-[calc(100dvh+100px)] w-full bg-transparent relative overflow-hidden">
      ...
      <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 text-2xl md:text-3xl font-semibold text-base-400 z-2">
        Our Partners
      </p>
      <motion.img
      ...
      <section className="h-full w-full pt-28 md:pt-32 px-[10px] md:px-20 flex flex-col items-center z-2 relative">
        ...
        >
          Together we can reduce food waste and fight hunger. Donate your
          surplus meals or pick up what you need every bite counts in building a
          more caring, sustainable community.
        </motion.p>
      </section>
    </header>
  );
